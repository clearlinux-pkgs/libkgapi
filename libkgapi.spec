...
Source0  : https://download.kde.org/stable/release-service/21.12.1/src/libkgapi-21.12.1.tar.xz
...
%prep
%setup -q -n libkgapi-21.12.1
cd %{_builddir}/libkgapi-21.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641929843
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkgapi-21.12.1/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/libkgapi/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/libkgapi-21.12.1/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/libkgapi/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/libkgapi-21.12.1/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/libkgapi/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/libkgapi-21.12.1/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/libkgapi/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/libkgapi-21.12.1/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/libkgapi/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/libkgapi-21.12.1/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/libkgapi/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/libkgapi-21.12.1/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/libkgapi/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
...
/usr/lib64/libKPimGAPIBlogger.so.5.19.1
/usr/lib64/libKPimGAPICalendar.so.5
/usr/lib64/libKPimGAPICalendar.so.5.19.1
/usr/lib64/libKPimGAPIContacts.so.5
/usr/lib64/libKPimGAPIContacts.so.5.19.1
/usr/lib64/libKPimGAPICore.so.5
/usr/lib64/libKPimGAPICore.so.5.19.1
/usr/lib64/libKPimGAPIDrive.so.5
/usr/lib64/libKPimGAPIDrive.so.5.19.1
/usr/lib64/libKPimGAPILatitude.so.5
/usr/lib64/libKPimGAPILatitude.so.5.19.1
/usr/lib64/libKPimGAPIMaps.so.5
/usr/lib64/libKPimGAPIMaps.so.5.19.1
/usr/lib64/libKPimGAPITasks.so.5
/usr/lib64/libKPimGAPITasks.so.5.19.1
