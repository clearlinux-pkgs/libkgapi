...
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/libkgapi-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/libkgapi-22.12.0.tar.xz.sig
...
%prep
%setup -q -n libkgapi-22.12.0
cd %{_builddir}/libkgapi-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670784461
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPimGAPIBlogger.so.5.22.0
/usr/lib64/libKPimGAPICalendar.so.5
/usr/lib64/libKPimGAPICalendar.so.5.22.0
/usr/lib64/libKPimGAPIContacts.so.5
/usr/lib64/libKPimGAPIContacts.so.5.22.0
/usr/lib64/libKPimGAPICore.so.5
/usr/lib64/libKPimGAPICore.so.5.22.0
/usr/lib64/libKPimGAPIDrive.so.5
/usr/lib64/libKPimGAPIDrive.so.5.22.0
/usr/lib64/libKPimGAPILatitude.so.5
/usr/lib64/libKPimGAPILatitude.so.5.22.0
/usr/lib64/libKPimGAPIMaps.so.5
/usr/lib64/libKPimGAPIMaps.so.5.22.0
/usr/lib64/libKPimGAPITasks.so.5
/usr/lib64/libKPimGAPITasks.so.5.22.0
