...
Version  : 22.04.2
Release  : 42
URL      : https://download.kde.org/stable/release-service/22.04.2/src/libkgapi-22.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/libkgapi-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/libkgapi-22.04.2.tar.xz.sig
...
%prep
%setup -q -n libkgapi-22.04.2
cd %{_builddir}/libkgapi-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654823574
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkgapi-22.04.2/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/libkgapi/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9
cp %{_builddir}/libkgapi-22.04.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/libkgapi/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/libkgapi-22.04.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/libkgapi/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/libkgapi-22.04.2/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/libkgapi/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/libkgapi-22.04.2/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/libkgapi/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/libkgapi-22.04.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/libkgapi/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/libkgapi-22.04.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/libkgapi/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/libkgapi-22.04.2/README.md.license %{buildroot}/usr/share/package-licenses/libkgapi/5906415d14f11136c25fd1433c5561706103e7cf
cp %{_builddir}/libkgapi-22.04.2/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/libkgapi/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
...
/usr/lib64/libKPimGAPIBlogger.so.5.20.2
/usr/lib64/libKPimGAPICalendar.so.5
/usr/lib64/libKPimGAPICalendar.so.5.20.2
/usr/lib64/libKPimGAPIContacts.so.5
/usr/lib64/libKPimGAPIContacts.so.5.20.2
/usr/lib64/libKPimGAPICore.so.5
/usr/lib64/libKPimGAPICore.so.5.20.2
/usr/lib64/libKPimGAPIDrive.so.5
/usr/lib64/libKPimGAPIDrive.so.5.20.2
/usr/lib64/libKPimGAPILatitude.so.5
/usr/lib64/libKPimGAPILatitude.so.5.20.2
/usr/lib64/libKPimGAPIMaps.so.5
/usr/lib64/libKPimGAPIMaps.so.5.20.2
/usr/lib64/libKPimGAPITasks.so.5
/usr/lib64/libKPimGAPITasks.so.5.20.2
